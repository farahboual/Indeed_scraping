...
class IndeedScraper(SeleniumScraper):
    ...
    def build_query_url(self,
        ...
        elif country == self.Country.France:
            region_code = 'fr'
    ...
    def search_for_jobs(self, max_pages=2, **search_params):
        ...
        for page in range(max_pages):
            ...
            if current_page <= max_pages:
                ...
                # Prepare to switch pages. Saving the last working link is helpful for error handling.
...
def main(max_pages=200, dont_search=False, dont_update_job_descriptions=False, **search_params):
